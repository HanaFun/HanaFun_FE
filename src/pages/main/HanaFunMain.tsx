...
export const HanaFunMain = () => {
  ...
  setCookie(
    'token',
    'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiLsnbTrr7zsp4AiLCJ1c2VySWQiOjEsImlhdCI6MTcxOTk2NTU5NiwiZXhwIjoxNzE5OTY5MTk2fQ.qIeRLw5gYrd5e1cckwRNQYpXoZhmmunLs9sZLwFMHZ0'
  );
