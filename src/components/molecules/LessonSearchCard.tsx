...
export const LessonSearchCard: FC<IProps> = ({ lesson }) => {
  ...
  return (
    <div
      className='bg-white flex justify-between gap-x-2 p-3 rounded-2xl cursor-pointer drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]'
    ...
    >
      ...
      <div className='w-2/3 flex flex-col justify-between px-2'>
        <div>
